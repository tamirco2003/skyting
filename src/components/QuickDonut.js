...
class QuickDonut extends Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                <Doughnut data={{ datasets: [{ data: Object.values(smallData), backgroundColor: this.props.colors }], labels: this.props.labels }} />
            </React.Fragment>
        )
    }
}

export default QuickDonut;